...
function config($stateProvider, $urlRouterProvider, $ocLazyLoadProvider, IdleProvider, KeepaliveProvider) {
    ...
    $stateProvider
        ...
        .state('dealership.dealerships', {
            url: "/dealership",
            templateUrl: "views/dealership.html",
            data: { pageTitle: 'Dealerships' },
        })
        .state('vehicles', {
            abstract: true,
            url: "/vehicles",
        ...
        .state('vehicles.vehicles', {
            url: "/vehicles",
            templateUrl: "views/vechicles.html",
        ...
        .state('settings.settings_1', {
            url: "/settings",
            templateUrl: "views/settings.html",
            data: { pageTitle: 'Settings' },
        })
        .state('financeConsultants', {
            abstract: true,
            url: "/financeConsultants",
            templateUrl: "views/common/content.html",
        })
        .state('financeConsultants.financeConsultants', {
            url: "/financeConsultants",
            templateUrl: "views/financeConsultants.html",
            data: { pageTitle: 'Finance Consultants' },
        })
        .state('analytics', {
            abstract: true,
            url: "/analytics",
